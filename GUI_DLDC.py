...
def run():
    os.system('python '+ currentfolder+'/main.py')

def selectzone():
    os.system('python '+ currentfolder+'/calibvideo.py')
...
def save():
    ...
    with open(currentfolder+'/config.txt', 'w') as file:
        file.write(strconfig)
        
    with open(currentfolder+'/config.txt', "r") as config:
        config = json.loads(config.read())
